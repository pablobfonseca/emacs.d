...
I am using the https://www.programmingfonts.org/#droidsansmono][DroidSansMono]] and [[https://fonts.google.com/specimen/Cantarell][Cantarell]] fonts for this configuration which will more than likely need to be installed on your machine.  Both can usually be found in the various Linux distro package managers or downloaded from the links above.

#+begin_src emacs-lisp
(set-face-attribute 'default nil :font "DroidSansM Nerd Font" :family "Regular" :height 190)

;; Set the fixed pitch face
(set-face-attribute 'fixed-pitch nil :font "DroidSansM Nerd Font" :family "Regular" :height 190)
