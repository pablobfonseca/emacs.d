...
augroup filetype_ruby
  ...
  autocmd FileType ruby nnoremap <Leader>rt :!ripper-tags -R --exclude=vendor<cr>
...
let g:ale_linters = { 'javascript': ['xo', 'eslint'], 'ruby': ['rubocop'] }
let g:ale_fixers = { 'javascript': ['xo', 'prettier', 'eslint'], 'ruby': ['rubocop'] }
...
#+begin_src json :tangle ./vim/coc-settings.json
  {
    ...
    "eslint.filetypes": ["javascript", "typescript", "jsx", "tsx"],
...
#+end_src
** coq_nvim
#+begin_src vimrc :tangle ./vim/rcplugins/coq_nvim
...
** css-colors
#+begin_src vimrc :tangle ./vim/rcplugins/css-colors
...
nnoremap <leader>rp :Dirbuf ~/.vim/rcplugins<cr>
nnoremap <leader>rf :Dirbuf ~/.vim/rcfiles<cr>
  " vim: ft=vim
#+end_src
...
#+end_src
** nvim-window
#+begin_src vimrc :tangle ./vim/rcplugins/nvim-window
Plug 'https://gitlab.com/yorickpeterse/nvim-window.git'

map <silent> <M-o> :lua require('nvim-window').pick()<CR>

" vim: ft=vim
#+end_src
** octo
#+begin_src vimrc :tangle ./vim/rcplugins/octo
...
nnoremap <C-x>t <cmd>Telescope tags<cr>
...
#+end_src
** vlang
#+begin_src vimrc :tangle ./vim/rcplugins/vlang
Plug 'ollykel/v-vim'
